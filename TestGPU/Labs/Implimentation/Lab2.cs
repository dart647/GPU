...
namespace TestGPU.Labs
{
    class Lab2 : ILab
    {
        public void Execute()
        {
            ...
            Image image = Image.FromFile($@"{ Directory.GetCurrentDirectory() }\input\Lab2Space.jpg");
            ...
            bmImage.Save($@"{ Directory.GetCurrentDirectory() }\output\Lab2SpaceConverted.jpg", ImageFormat.Jpeg);
